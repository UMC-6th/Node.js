...
import { getReview, getMission, completeMission } from "../providers/user.provider.js";
...
export const missionComplete = async (req, res, next) => {
    return res.send(response(status.SUCCESS, await completeMission(req.params.storeId, req.query)));
}