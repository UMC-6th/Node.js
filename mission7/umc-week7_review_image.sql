...
CREATE TABLE `review_image` (
  ...
  `review_id` bigint DEFAULT NULL COMMENT 'index',
  `image_url` text COMMENT 'url',
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3 COMMENT='리뷰 사진';
...
-- Dump completed on 2024-05-26  0:08:31
