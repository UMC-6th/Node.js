...
CREATE TABLE `mission` (
  ...
  `reward` int NOT NULL DEFAULT '0' COMMENT '보상',
  `deadline` datetime DEFAULT NULL COMMENT '마감일',
  `mission_spec` text COMMENT '내용',
  `created_at` datetime(6) DEFAULT NULL COMMENT '생성일',
  `updated_at` datetime(6) DEFAULT NULL COMMENT '수정일',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3 COMMENT='미션';
...
-- Dump completed on 2024-05-26  0:08:33
